...
@Component({
  selector: 'app-card-filters-module',
  templateUrl: './card-filters-module.component.html',
  styleUrls: ['./card-filters-module.component.css']
})
export class CardFiltersModuleComponent implements OnInit {
